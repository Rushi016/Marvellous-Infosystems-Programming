//  1. Wirte a program which accept range from user and display all numbers
...
/*
    ...
    Output:
    D:\Marvellous Infosystems\Logic Building with Industrial Project Batch\Logic Building Assignments\Logic Building Assignment 9>gcc Assignment9_1.c
