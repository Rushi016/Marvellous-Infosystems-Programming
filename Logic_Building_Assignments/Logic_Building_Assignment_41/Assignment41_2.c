//  2. Write a program which search last occurrence of particular element
...
int main()
{
    ...
    {
        printf("Last occurrence of the element at position : %d\n",iRet);
    }
...
/*
    ...
    Output:
    D:\Marvellous_Infosystems\Logic_Building_with_Industrial_Project_Batch\Logic_Building_Assignments\Logic_Building_Assignment_41>gcc Assignment41_2.c 
    ...
    Enter Search Element :
    30
    Last occurrence of the element at position : 6
