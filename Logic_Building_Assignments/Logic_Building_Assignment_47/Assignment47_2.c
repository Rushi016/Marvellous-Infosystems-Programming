...
/*
    ...
    Output:
    D:\Marvellous_Infosystems\Logic_Building_with_Industrial_Project_Batch\Logic_Building_Assignments\Logic_Building_Assignment_47>gcc Assignment47_2.c  
    ...
    Number of Small Characters are : 27
