...
Output:
D:\Marvellous Infosystems\Python Data Science Machine Learning with Automation\Automation\Automation Assignments\Automation Assignment 11>python Assignment11_4.py Temp 
--------------Marvellous Infosystems By Piyush Khairnar------------
-----------------Application name is Assignment11_4.py ------------

Duplicates files deleted successfully
Time required for this script is :  0.03562188148498535
Check Log.txt file
